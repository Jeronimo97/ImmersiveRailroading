...
public class Config {
    ...
    public static class ConfigBalance {
        ...
        public static String[] waterTypes = new String[] {
                "water", "dist_water", "hot_spring_water", "purified_water"
        };
        ...
        public static List<ItemStack> getVillagerPayout() {
            return Arrays.stream(villagerPayoutItems).map(f -> f.example())
    ...
    public static boolean isFuelRequired(final Gauge gauge) {
        return !(!ConfigBalance.FuelRequired
                || (!ConfigBalance.ModelFuelRequired && gauge.isModel()));
    }
